    ...
    <Layout>
      <div style={{ fontFamily: "'Inter', 'Plus Jakarta Sans', sans-serif" }} className="flex h-screen overflow-hidden bg-[#0C0F1A] text-white relative">
        ...
        <style>{`
          ...
          * { box-sizing: border-box; }
          ...
          .stat-card::before {
            ...
            background: radial-gradient(ellipse at top left, var(--accent-bg) 0%, transparent 70%);
          }
            ...
            {menuItems.filter(m => m.roles.includes(user.role)).map(item => (
              <button
                ...
                style={{
                  ...
                  color: activeTab === item.id ? "#63B3ED" : "rgba(255,255,255,.55)",
                  fontSize: 13.5, fontWeight: activeTab === item.id ? 700 : 500,
          ...
          <div style={{ padding: "12px 12px 24px", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
            <button
              ...
              style={{
                ...
                width: "100%", padding: "11px 12px", borderRadius: 12,
                background: "none", border: "none", cursor: "pointer",
                color: "rgba(255,255,255,.35)", fontSize: 13.5, fontWeight: 500,
        ...
        <main style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minWidth: 0 }}>
          ...
          {/* Top bar */}
          <header style={{
            height: 72, background: "rgba(12,15,26,.85)", backdropFilter: "blur(20px)",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              {loading && (
                <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: "#63B3ED", fontWeight: 600 }}>
                  <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#63B3ED", animation: "pulse-ring 1.4s ease infinite" }} />
                  Syncing…
                </div>
              )}
              <div style={{ background: "rgba(99,179,237,.12)", border: "1px solid rgba(99,179,237,.25)", borderRadius: 99, padding: "6px 14px", fontSize: 11, fontWeight: 700, letterSpacing: ".8px", color: "#63B3ED" }}>
                {user.role}
              </div>
            </div>
          </header>
                  ...
                  <form onSubmit={handleUpdateProfile}>
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
                      <div>
                        ...
                        <input className="input-field" type="text" value={profileData.name}
                          onChange={e => setProfileData({ ...profileData, name: e.target.value })} />
                      </div>
                      <div>
                        <label className="label-text">Email Address</label>
                        <input className="input-field" type="email" value={profileData.email} disabled
                ...
                <div style={{ padding: "20px 24px", borderBottom: "1px solid rgba(255,255,255,0.07)", display: "flex", flexWrap: "wrap", gap: 12, alignItems: "center", justifyContent: "space-between" }}>
                  ...
                  <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                    <div style={{ position: "relative" }}>
                      <input className="input-field" placeholder="Search…" style={{ width: 220, paddingLeft: 38 }}
                              ...
                              <div style={{ display: "flex", justifyContent: "flex-end", gap: 8 }}>
                                {["inventory","staff"].includes(activeTab) && <>
                                  ...
                                  <button onClick={() => handleAction(activeTab === "inventory" ? "equipment" : "staff", "DELETE", null, item.id)}
                                    ...
                                    onMouseLeave={e => e.currentTarget.style.background = "rgba(252,129,129,.1)"}>
                                    Delete
                                  </button>
                                </>}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                <div>
                  ...
                  <select className="select-field" value={forms.equipment.category}
                ...
                <div>
                  ...
                  <input className="input-field" placeholder="Caterpillar" value={forms.equipment.brand}
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                <div>
                  ...
                  <input className="input-field" placeholder="Lagos" value={forms.equipment.region}
                    onChange={e => setForms({ ...forms, equipment: { ...forms.equipment, region: e.target.value } })} />
                </div>
                <div>
                  <label className="label-text">Daily Rate (₦)</label>
                  <input className="input-field" type="number" placeholder="150000" value={forms.equipment.dailyRate}
                    onChange={e => setForms({ ...forms, equipment: { ...forms.equipment, dailyRate: e.target.value } })} />
                </div>
              </div>
              <div>
                <label className="label-text">Description</label>
                <textarea className="input-field" placeholder="Equipment specifications…" rows={3}
                  style={{ resize: "none" }} value={forms.equipment.description || ""}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {[
                ...
                <div key={f.key}>
                  ...
                  <input className="input-field" placeholder={f.placeholder} value={forms.staff[f.key]}
                    onChange={e => setForms({ ...forms, staff: { ...forms.staff, [f.key]: e.target.value } })} />
                </div>
              ))}
              <div style={{ border: "1px dashed rgba(255,255,255,.15)", borderRadius: 14, padding: 20, background: "rgba(255,255,255,.02)" }}>
