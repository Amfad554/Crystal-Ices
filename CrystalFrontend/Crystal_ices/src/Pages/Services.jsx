  ...
  const serviceList = [
    {
      ...
      fullContent: {
        intro: "We provide specialized technical advisory and end-to-end project management for the Nigerian energy sector, ensuring compliance with NUPRC and international standards.",
        features: ["NUPRC/DPR Permit Processing", "Environmental Impact Assessments", "Project Lifecycle Management", "Regulatory Compliance Audits"],
        gallery: [
    ...
    },
    {
      ...
      icon: "💧",
      mainImage: "https://images.unsplash.com/photo-1516937941344-00b4e0337589?auto=format&fit=crop&q=80&w=1600",
      description: "Sourcing high-grade infrastructure components.",
      fullContent: {
        intro: "Strategic sourcing of precision-engineered components for refineries, pump stations, and jetty terminals across Lagos and the Niger Delta.",
        features: ["Industrial Valve Procurement", "Refinery Component Sourcing", "Global Supply Chain Logistics", "Quality Assurance & Inspection"],
        gallery: [
    ...
    },
    {
      ...
      fullContent: {
        ...
        features: ["Excavator & Crane Leasing", "Preventative Maintenance Plans", "Certified Operator Manpower", "24/7 On-site Technical Support"],
        gallery: [
    ...
    },
    {
      ...
      fullContent: {
        intro: "Facilitating the acquisition and development of high-value industrial land for tank farms, warehouses, and energy facilities in Lagos.",
        features: ["Industrial Land Acquisition", "Tank Farm Site Development", "Facility Lease Management", "Zoning & Legal Compliance"],
        gallery: [
      ...
      <div className="bg-white min-h-screen">
        ...
        <section className="py-16 px-6 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {serviceList.map((service) => (
            <div key={service.id} className="bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-md transition-all flex flex-col">
        ...
        {selectedService && (
          <div className="fixed inset-0 bg-white z-[999] overflow-y-auto">
            ...
            <nav className="sticky top-0 bg-white/95 backdrop-blur-sm border-b z-50 px-6 py-4 flex justify-between items-center">
              <span className="text-sm font-bold text-slate-900 uppercase tracking-widest">{selectedService.title}</span>
              <button 
            ...
            <article>
              ...
              <div className="h-[40vh] md:h-[50vh] relative">
                <img src={selectedService.mainImage} className="w-full h-full object-cover" alt="Service Header" />
                <div className="absolute inset-0 bg-black/30 flex items-end p-8 md:p-16">
                   <h2 className="text-white text-3xl md:text-5xl font-black max-w-3xl">{selectedService.title}</h2>
                </div>
              </div>
              ...
              <div className="max-w-6xl mx-auto px-6 py-12 md:py-20 grid grid-cols-1 lg:grid-cols-3 gap-16">
                <div className="lg:col-span-2">
                  <h3 className="text-xl font-bold text-slate-900 mb-6">Service Overview</h3>
                  <p className="text-lg text-slate-600 leading-relaxed mb-10">
                    {selectedService.fullContent.intro}
                  </p>

                  <h3 className="text-xl font-bold text-slate-900 mb-6">Capabilities & Specializations</h3>
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-6">Operational Showcase</h3>
                ...
                <aside className="lg:col-span-1">
                  <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 sticky top-24">
                    <h4 className="text-lg font-bold text-slate-900 mb-4">Direct Inquiry</h4>
                    <p className="text-sm text-slate-500 mb-6">Consult with our engineering team regarding your specific project requirements.</p>
                    ...
                    <div className="pt-6 border-t border-slate-200">
                      <p className="text-xs text-slate-400 font-bold uppercase mb-2">Technical Standards</p>
                      <p className="text-xs text-slate-600">ISO 9001:2015 Compliant Processes • NUPRC Certified Vendor</p>
                    </div>
                  </div>
                </aside>
              </div>
